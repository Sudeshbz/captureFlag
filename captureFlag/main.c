...
if(yeniX>=0&& yeniX<size&& yeniY>=0 &&yeniY< size&& board[yeniX][yeniY]!=PLAYER2){
    board[*x][*y]='.';
    *x=yeniX;
    *y=yeniY;
        board[*x][*y]=(board[*x][*y]==FLAG)?FLAG:playerp;
        //If the flag is captured, leave it on the board
}
